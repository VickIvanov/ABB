...
***Важно обратить внимание, что БД по этой ссылке выложена не полностью, в отличие от полной структуры, представленной [по этой ссылке](https://drive.google.com/file/d/1nlDj2VaAdCQKE6Uxhq3f78gMg_4m_2ak/view?usp=sharing)***

DB postgree:

http://31.148.136.80:5432
